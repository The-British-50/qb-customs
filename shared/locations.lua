...
18: Emergency   19: Military    20: Commercial  21: Trains
 ...
 Config.Locations = {
     ...
     ['MRPD'] = {
         ...
         zones = {
             { coords = vector3(462.75, -1019.53, 28.1), length = 9.0, width = 4.0, heading = 90.0, minZ = 24.5, maxZ = 28.5 },
             { coords = vector3(462.42, -1015.07, 28.07), length = 9.0, width = 4.0, heading = 90.0, minZ = 24.5, maxZ = 28.5 },
         }
     },
